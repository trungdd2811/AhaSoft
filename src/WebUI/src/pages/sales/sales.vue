  ...
  <div id="container">
    <section id="content">
      <div class="inner_1400">
        ...
        <!-- <div class="upbtn"><img src="template/images/contents1/up_gray.png" alt="up_gray"></div> -->
        <article id="Sales_tab">
          <!-- <div class="tabBox">
            <ul class="clearfix">
              <li class="on">Invoice</li>
              <li>Booking</li>
              <li>Prepaid Cards</li>
